...
<div>
<ul>
<ParamsItem className={"paramsItem"} param={{"name":"petId","in":"path","description":"ID of pet to update","required":true,"schema":{"type":"integer","format":"int64"}}}></ParamsItem>
</ul>
</div>
</details>

<MimeTabs>
<TabItem label={"application/octet-stream"} value={"application/octet-stream-schema"}>
