...
<div>
<ul>
<ParamsItem className={"paramsItem"} param={{"name":"username","in":"query","description":"The user name for login","required":true,"schema":{"type":"string"}}}></ParamsItem>

<ParamsItem className={"paramsItem"} param={{"name":"password","in":"query","description":"The password for login in clear text","required":true,"schema":{"type":"string"}}}></ParamsItem>
</ul>
</div>
</details>
...
<details style={{"textAlign":"left","marginBottom":"1rem"}} data-collaposed={true} open={false}>
<summary style={{}}>
...
<summary style={{}}>
<strong>X-Rate-Limit</strong>

<span style={{"opacity":"0.6"}}> integer</span>
</summary>
...
<ResponseSamples responseExample={"OK"} language={"json"}></ResponseSamples>
</TabItem>
</SchemaTabs>
</TabItem>
...
<TabItem label={"response"} value={"response"}>
<ResponseSamples responseExample={"<Message> OK </Message>"} language={"xml"}></ResponseSamples>
</TabItem>
</SchemaTabs>
</TabItem>
...
<TabItem label={"response"} value={"response"}>
<ResponseSamples responseExample={"OK"} language={"shell"}></ResponseSamples>
</TabItem>
</SchemaTabs>
</TabItem>
</MimeTabs>
