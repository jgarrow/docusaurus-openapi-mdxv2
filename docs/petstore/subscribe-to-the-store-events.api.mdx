...
<SchemaItem collapsible={false} name={"callbackUrl"} required={true} schemaName={"uri"} qualifierMessage={undefined} schema={{"type":"string","format":"uri","description":"This URL will be called by the server when the desired event will occur","example":"https://myserver.com/send/callback/here"}}></SchemaItem>

<SchemaItem collapsible={false} name={"eventName"} required={true} schemaName={"string"} qualifierMessage={"**Possible values:** [`orderInProgress`, `orderShipped`, `orderDelivered`]"} schema={{"type":"string","description":"Event name for the subscription","enum":["orderInProgress","orderShipped","orderDelivered"],"example":"orderInProgress"}}></SchemaItem>
</ul>
</details>
</TabItem>
</MimeTabs>
...
<ul style={{"marginLeft":"1rem"}}>
<SchemaItem collapsible={false} name={"subscriptionId"} required={false} schemaName={"string"} qualifierMessage={undefined} schema={{"type":"string","example":"AAA-123-BBB-456"}}></SchemaItem>
</ul>
</details>
</TabItem>
